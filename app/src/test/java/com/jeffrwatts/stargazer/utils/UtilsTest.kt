...
class UtilsTest {
    ...
    fun calculatePosition() {
        ...
        val (alt1, azm1, lha1) = Utils.calculatePosition(SIRIUS_RA, SIRIUS_DEC, KONA_LATITUDE, KONA_LONGITUDE, julianDate)
        ...
        val (alt2, azm2, lha2) = Utils.calculatePosition(SIRIUS_RA, SIRIUS_DEC, TOKYO_LATITUDE, TOKYO_LONGITUDE, julianDate)
        assertEquals(24.70721174963697, alt2, 0.01)
        assertEquals(136.08356306211235, azm2, 0.01)
        assertEquals(318.86516337, lha2, 0.01)

        val (alt3, azm3, lha3) = Utils.calculatePosition(SIRIUS_RA, SIRIUS_DEC, CAPE_TOWN_LATITUDE, CAPE_TOWN_LONGITUDE, julianDate)
        ...
        val (alt4, azm4, lha4) = Utils.calculatePosition(SIRIUS_RA, SIRIUS_DEC, SYDNEY_LATITUDE, SYDNEY_LONGITUDE, julianDate)
        assertEquals(58.38462821975049, alt4, 0.01)
        assertEquals(64.56698046413477, azm4, 0.01)
        assertEquals(330.38276337, lha4, 0.01)

        val (alt5, azm5, lha5) = Utils.calculatePosition(VEGA_RA, VEGA_DEC, KONA_LATITUDE, KONA_LONGITUDE, julianDate)
        ...
        val (alt6, azm6, lha6) =  Utils.calculatePosition(VEGA_RA, VEGA_DEC, TOKYO_LATITUDE, TOKYO_LONGITUDE, julianDate)
        ...
        val (alt7, azm7, lha7) =  Utils.calculatePosition(VEGA_RA, VEGA_DEC, CAPE_TOWN_LATITUDE, CAPE_TOWN_LONGITUDE, julianDate)
        ...
        val (alt8, azm8, lha8) =  Utils.calculatePosition(VEGA_RA, VEGA_DEC, SYDNEY_LATITUDE, SYDNEY_LONGITUDE, julianDate)
